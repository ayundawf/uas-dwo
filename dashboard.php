...
<body>
    ...
    $a = 1;
    $query_customer = mysqli_query($conn, "SELECT SUM(f.TaxAmt) as customer FROM fact_purchase f JOIN time t ON f.TimeID=t.time_id GROUP BY t.bulan ORDER BY t.tanggallengkap");
