                                ...
                                <div class="row no-gutters align-items-center">
                                    <div class="col mr-2">
                                        ...
                                        <div class="h5 mb-0 font-weight-bold text-gray-800">
                                            <?php
                                            $query = mysqli_query($conn, "SELECT SUM(f.OrderQty) kuantitas FROM fact_purchase f 
                                            JOIN time t ON f.timeID=t.time_id WHERE t.tahun=2004");
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            $query = mysqli_query($conn, 'SELECT ROUND(AVG(f.SubTotal), 2) avg FROM fact_purchase f 
                                            JOIN time t ON f.timeID=t.time_id WHERE t.tahun=2004');
                                            $row = mysqli_fetch_array($query);
